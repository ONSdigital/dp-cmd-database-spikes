...
MATCH (d1:CensusEthnicity_Dimension1 {value:'2011'}), (d2:CensusEthnicity_Dimension2 {value:'K04000001'}), (d3:CensusEthnicity_Dimension3) WHERE d3.value='White: Argentinian' OR d3.value='White: Irish' WITH d1,d2,d3 MATCH (d1)<-[:has]-(o:CensusEthnicity_Observation)-[:has]->(d2), (d3)<-[:has]-(o) return o,d1,d2,d3

MATCH (d1:CensusEthnicity_Dimension1 {value:'2011'}), (d2:CensusEthnicity_Dimension2 {value:'K04000001'}), (d3:CensusEthnicity_Dimension3) WHERE d3.value='White: Argentinian' OR d3.value='White: Irish' OR d3.value='White: Albanian' WITH d1,d2,d3 MATCH (d1)<-[:has]-(o:CensusEthnicity_Observation)-[:has]->(d2), (d3)<-[:has]-(o) return o,d1,d2,d3